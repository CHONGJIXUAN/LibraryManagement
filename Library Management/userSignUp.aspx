                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="UserID" runat="server" CssClass="form-control" placeholder="Member ID"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="from group">
                            <div class="form-group text-center">
                                <asp:Button ID="SignUp" runat="server" Text="Sign Up" class="btn btn-success btn-block btn-lg" OnClick="SignUp_Click"/>
                            </div>
                        </div>

                       <div class="from group">
                            <div class="form-group text-center">
                                <asp:Button ID="Login" runat="server" Text="Login" class="btn btn-info btn-block btn-lg" OnClick="Login_Click"/>
                            </div>
                        </div>
